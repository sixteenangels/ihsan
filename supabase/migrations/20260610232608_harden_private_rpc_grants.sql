-- Keep browser-facing RPCs available while removing direct access to private helpers.
-- Public wrappers run as security definer and call private functions internally.
